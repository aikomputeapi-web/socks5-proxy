...
func ParseConfig() *Config {
	...
	flag.DurationVar(&cfg.CheckTimeout, "check-timeout", 5*time.Second, "proxy check timeout")
	flag.IntVar(&cfg.MaxConcurrent, "max-concurrent", 200, "max concurrent health checks")
	flag.Parse()
